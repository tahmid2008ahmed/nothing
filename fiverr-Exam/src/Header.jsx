            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  {/* "Get Started" button */}
                  <li role="none" className="flex mt-6 items-stretch">
                    <button className="inline-flex h-10 items-center justify-center gap-2 whitespace-nowrap rounded bg-[#1A5EFF] px-5 text-sm font-medium tracking-wide text-white shadow-md  shadow-emerald-200 transition hover:shadow-sm hover:shadow-emerald-200 hover:bg-[#00008B] focus:shadow-sm  focus-visible:outline-none disabled:cursor-not-allowed disabled:border-emerald-300 disabled:bg-emerald-300 disabled:shadow-none lg:px-8 duration-500">
